    ...
    companion object {
        ...
        fun insertUserData(context: Context, userDetailTable: UserDetailWithRelations) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                appDatabase!!.userDetailDao().insertUserDetailWithRelations(userDetailTable.userDetail,userDetailTable.mobileNumbers,userDetailTable.addresses,userDetailTable.educations)
